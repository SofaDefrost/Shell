...
\tomas{I'm adding this back, the previous focuess only on physical correctnes.}
Apart from physical accuracy the model should provide 
...
All these requirements are fullfilled by the shell element model.
