...
Eq. showing rest position stuff

Fullfills requirements + collision

Test with tube + convergence

\section{Simulation of Surgical Procedures}

surgical low-level tasks done with rest position trick (joining, patch, complex cutting/suturing)
