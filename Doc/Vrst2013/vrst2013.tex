\documentclass[sposored]{acmsiggraph}
...
\begin{tabular}[t]{cccc}%
  Tom\'a\v{s} Golembiovsk\'y\thanks{nyoxi@ics.muni.cz} &
  Igor Peterl\'ik &
  Christian Duriez &
  St\'ephane Cotin \\
%
...
%}
\pdfauthor{Tom\'a\v{s} Golembiovsk\'y}
...
The measures performed on the capsule report stiffness which is significantly higher than that of the parenchyma, however, 
...
% Categories
\begin{CRcatlist}
  \CRcat{I.6.5}{Simulation and Modeling}{Model Development}
  \CRcat{J.3}{Life and Medical Sciences}{Health};
\end{CRcatlist}

\keywords{deformable liver model, Glisson's capsule}
...
Figure~\ref{fig-aspiration3} presents the evolution of displacement in time at central node on the cube surface. The effect of increased combined stiffness is clearly visible.
