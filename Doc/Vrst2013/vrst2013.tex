...
In this case the simulation is performed with the pressure of 30\,kPa and with
...
specified in the paper. \TG{add figure?}
...
global deformations where we believe the capsule plays also an essential role.
...
integrated our model with the with the vasularization method proposed
...
The model was validated for local displacements based on the the aspiration test presented in~\cite{Hollenstein2006} 
