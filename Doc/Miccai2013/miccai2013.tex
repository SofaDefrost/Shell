...
(for example kidneys). We will also focus on better description of the mechanical interaction between the organs in the abdominal 
cavity employing a realistic modeling of constraints and contacts.
