...
It is known that the parenchyma exhibits non-linear viscoelastic behaviour \cite{marchesseauMJED}.
...
The parenchyma is modeled using corotational finite elements~\cite{Felippa}.
...
corotational formulation described above~\cite{Duriez}. As such the model also handles geometric
