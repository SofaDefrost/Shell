...
The final constituent represented by Glisson's capsule has been already studied in the literature. 
Extensive experiments on porcine liver have been published in~\cite{Umale2013}. The measurements show that although being very 
...
linked together via mechanical coupling. We show that the model mimics the local experiments described in~\cite{Hollenstein2006}.
...
\begin{figure}[htb]
  ...
  \begin{tabular}{cc}
    ...
    \includegraphics[height=1.5in]{aspiration.pdf}\\
    a) & b)
  \end{tabular}
