...
model in context of local deformations and finally we analyze the influence of
the capsule on the global deformations of the liver and show that despite the
small thickness it plays an important role also in the global context.
...
\begin{figure}[htb]
  \centering
    \includegraphics[width=.25\textwidth]{gravity.jpg}
