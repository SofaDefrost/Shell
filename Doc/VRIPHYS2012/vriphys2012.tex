...
(ii) the deformations are completly symmetric and
...
Then based on definition of the B\'ezier triangle a surface is interpolated.}
...
our B\'ezier shell element (BSH) and elemnt of O. Comas (PSH) with polynomial shape function.}
