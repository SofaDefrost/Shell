...
In the following text the index $j \in [4;10]$ refers to edge points and index $i \in [1;3]$ to the associated corner point/node.
...
For the central point we again apply interpolation of \eqref{eq-central}.
