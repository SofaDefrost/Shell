...
The second limitation is the choice of rigidly attached control
...
visualisation. We also provide a technique of computing velocities of any point
on the surface and formula for back-projection of normal forces applied on the
surface onto the mechanical mesh. Those are form an essential component for the
surgical simulator as they are necessary if contact modeling between simulation
mesh and mechanical mesh is desired or other interaction with the mesh is
required.

At the end we present examples showing the convergence to the optimal solution
and the application of the model for several simulation tools. 
