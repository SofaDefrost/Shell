...
The corotational frame is computed followingly: 

\begin{itemize}
    \item One axis is alligned to one edge of the element:\\
...
forces applied on the object's surface are trasmitted back as forces
