...
We define a local system of coordinates $(x,y,z)$ in which the axis z is oriented along the thickness of the element. (\CD{TODO: figure}) 
For the shell formulation, there is no need to compute the derivatives along axis $z$.

The 2D tensor of deformation can be defined as a $2\times2$ matrix in which the components $k=\{x,y\}$ and $l=\{x,y\}$are:
\begin{equation}
F_{kl} = \frac{\delta T^k}{\delta l}   
\end{equation}
