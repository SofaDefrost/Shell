...
.add< MeshInterpolator<defaulttype::Rigid3fTypes> >(true) // default template
#else
//.add< MeshInterpolator<defaulttype::Vec3dTypes> >(true) // default template
.add< MeshInterpolator<defaulttype::Rigid3dTypes> >(true) // default template
# ifndef SOFA_DOUBLE
...
//.add< MeshInterpolator<defaulttype::Vec3dTypes> >()
