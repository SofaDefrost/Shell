...
\begin{figure}[ht]
\centering 
\subfloat[ ]{\includegraphics[width=5cm]{chapter6/cube_and_curves1.pdf}}
\hspace{0.5cm}
\subfloat[ ]{\includegraphics[width=8cm]{chapter6/cube_and_curves2.pdf}}
\caption [Computational timings within SOFA] {(a) FEM mesh of cube with $29\,791$ nodes deformed under a uniformed load. (b) Comparison of GPU computational timings and CPU overheads between the SOFA and standalone implementations for different mesh sizes. \TODO{change the cube if I can get a decent visual model in SOFA}}
