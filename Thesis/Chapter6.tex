...
\begin{figure}[h]
\begin{center}
\includegraphics[width=10cm]{chapter6/stressCurvesCube2.pdf}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=13.9cm]{chapter6/cubeAnisotropic.pdf}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=10cm]{chapter6/stressDecay.pdf}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=13.9cm]{chapter6/timingsGPU.pdf}
\end{center}
...
\TODO{Add comparison of different implementations}
...
\begin{figure}
\includegraphics[width=13.9cm]{chapter6/cube_and_curves.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=13.9cm]{chapter6/liver.pdf}
\end{center}
...
\TODO{timestep monitoring + stiffness}
...
\TODO{contact ok with fixed rigid surface only + the fact that it depends on application (good for brain shift but limit for liver in interactions with tools}
