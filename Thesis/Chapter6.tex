...
\TODO{If time, add comparison of different implementations}
...
\begin{figure}[ht]
\includegraphics[width=13.5cm]{chapter6/cube_and_curves.pdf}
\caption [Computational timings within SOFA] {\textbf{Left:} FEM mesh of cube with $29\,791$ nodes deformed under a uniformed load. \textbf{Right:} Comparison of GPU computational timings and CPU overheads between the SOFA and standalone implementations for different mesh sizes. \TODO{change the graph + nicer visual model?}}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=13.5cm]{chapter6/liver.pdf}
\end{center}
