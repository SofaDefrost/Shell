...
\usepackage{natbib}					
\defcitealias{Board05}{OpenGL}
\defcitealias{DirectX10}{DirectX}
\defcitealias{Meshlab}{Meshlab}
...
% Links in pdf
\usepackage{color}
\definecolor{linkcol}{rgb}{0,0,0}		%  {0,0,0.4}
\definecolor{citecol}{rgb}{0,0,0} 	%  {0.5,0,0}
...
%\usepackage{natbib}                  					% Put References at the end of each chapter. Do not put 'sectionbib' option here. Sectionbib option in 'natbib' will do.
