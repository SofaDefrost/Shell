\chapter[Modelling the deformation of solid objects in real-time][Modelling solid objects in real-time]{Modelling the deformation of solid objects in real-time}
\label{chap4}
\begin{shortAbstract}
...
\caption[Deformation of cylinders]{A geometrically linear finite element model (green) is compared to a co-rotational finite element model (yellow). While still using a simple linear strain measure, the co-rotational formulation is not sensitive to rotations and thus does not overdeform.}
