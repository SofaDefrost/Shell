...
\TODO{+add paper ISBMS 2010?}

\ON
Recently, \cite{Zhu10} proposed a framework based on point-based simulation techniques to model organ deformations realistically. They combined a new strain-stress tensor computation scheme with smoothed particule hydrodynamics (SPH) method. The parameters of the tensor relating strain and stress are determined through mechanical experiments. 
