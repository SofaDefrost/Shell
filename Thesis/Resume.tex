...
Bien que les deux modèles de tissus sont basés sur la mécanique continue pour une meilleure précision, ils sont tous les deux capables de simulation la déformation d'organes en temps réel. Enfin, leur implémentation dans l'environnement open source SOFA rendra publique ces deux modèles afin de participer à l'amélioration du réalisme des simulateurs médicaux. 
